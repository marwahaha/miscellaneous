...
* [CTFTime.org][CTFTime] [Competitions]
* [Computer Security Student]
* [Vulnerable Web Page]
* [RPISEC's Modern Binary Exploitation class](http://security.cs.rpi.edu/courses/binexp-spring2015/)
* [Damn Vulnerable Web App]
* [crytopals.com Matasano Crypto Challenges][cryptopals.com]



__Resources/Readings__
----------------------

* __General__
    + [Skull Security]
    + [MITRE Cyber Academy][MITRE]
    + [Trail of Bits]
    + [CTFTime.org][CTFTime] [Writeups]  
    + [Hexcellents CTF Knowledge Base]
    + [InsomniHack PDF]
* __Binary Exploitation__
    *  Buffer Overflows
          * [insecure.org Tutorial](http://insecure.org/stf/mudge_buffer_overflow_tutorial.html)
          * [exploit-db Tutorial](https://www.exploit-db.com/docs/28475.pdf)
          * [How to Bypass ASLR...](https://penturalabs.wordpress.com/2011/03/31/vulnerability-development-buffer-overflows-how-to-bypass-full-aslr/)
          * [Disable DEP/NX on Linux in Grub](https://gist.github.com/joswr1ght/a45d000ceaccf4cce6cb)
    * Return Oriented Programming
          ...
          * [Return Oriented Programming Hands On Video](https://www.youtube.com/watch?v=tqO3gU-IVos)
    * Shellcode
          * [Beginning Writing Shellcode](http://www.vividmachines.com/shellcode/shellcode.html)
    * Assembly
          * [x86 calling conventions](https://en.wikipedia.org/wiki/X86_calling_conventions)
          * [Skull Security]'s [Guide](https://wiki.skullsecurity.org/index.php?title=Fundamentals)
          * [CodeArcana's "A brief introduction to x86 calling conventions"](http://codearcana.com/posts/2013/05/21/a-brief-introduction-to-x86-calling-conventions.html)
          * [Assembly Programming Tutorial](http://www.tutorialspoint.com/assembly_programming/index.htm)
    * GDB
          * [Using GDB](http://web.mit.edu/gnu/doc/html/gdb_1.html)
    * PTrace
          * [The Basics of PTrace](http://www.linuxjournal.com/article/6100)
    * Format String `printf` Exploits
          * [PicoCTF video](https://www.youtube.com/watch?v=2HxyGWD1htg)
          * [CodeArcana post](http://codearcana.com/posts/2013/05/02/introduction-to-format-string-exploits.html)
    * Miscellaneous
          * [Exploiting `strcpy`](https://pointerless.wordpress.com/2012/02/26/strcpy-security-exploit-how-to-easily-buffer-overflow/)
          * `printf` Format String Vulnerability
              1. [Syracuse Lecture Notes](http://www.cis.syr.edu/~wedu/Teaching/cis643/LectureNotes_New/Format_String.pdf)
              2. [Stanford Lecture Notes](https://crypto.stanford.edu/cs155/papers/formatstring-1.2.pdf)
    * Radare
...
* __Network Forensics__
    * [Decrypting SSL Traffic with Wireshark](https://warroom.securestate.com/index.php/decrypting-ssl-traffic-with-wireshark/)
* __Filesystems__
    * [The Second Extended Filesystem]
    * [SquashFS Howto](http://tldp.org/HOWTO/SquashFS-HOWTO/)
* __Filetypes__
    * [GIF]s
        * [The Data in the Bytes](http://www.matthewflickinger.com/lab/whatsinagif/bits_and_bytes.asp)
    * [ZIP files]
        * [Recovering a ZIP file password](http://www.tech-faq.com/how-can-i-recover-a-zip-password.html)
        * [Cracking ZIP and RAR files with John the Ripper](http://www.cybercrimetech.com/2014/07/how-to-cracking-zip-and-rar-protected.html)
* __Linux__
    - [Ryan's Tutorials] ... the basics and all-around "how-to" of [Linux]!
    - [Linux Fundamentals] ... a more in-depth book of [Linux] commands.
    - [Environment Variables](https://www.win.tue.nl/~aeb/linux/hh/hh-8.html)
    - [The Linux System Administrator's Guide]
    - [Command Line Kung Fu]
* __[Steganography](http://www.garykessler.net/library/steganography.html)__
    - [Long-Expose Photography with OpenCV/Hipshot](http://www.eliteraspberries.com/blog/2013/01/simulate-long-exposure-photography-with-opencv.html)
* __Web Exploitation__
    - [sqlmap and Google Dorks](www.darkmoreops.com/2014/08/28/use-sqlmap-sql-injection-hack-website-database/)
    - [sqlmap training resources](https://ma.ttias.be/sql-injection-test-targets-websites/) 
    - [Null Byte Injection in PHP](http://resources.infosecinstitute.com/null-byte-injection-php/)
    - ["NoSQL? No problem! Pillaging MongoDB for Fun and Profit"](http://pen-testing.sans.org/blog/2015/12/03/nosql-no-problem-pillaging-mongodb-for-fun-and-profit)
    - [Hacking NodeJS and MongoDB](http://blog.websecurify.com/2014/08/hacking-nodejs-and-mongodb.html)
    - [Blackhat's "Server-Side JavaScript Injection"](https://media.blackhat.com/bh-us-11/Sullivan/BH_US_11_Sullivan_Server_Side_WP.pdf)
    - ["Server-Side JavasScript Web Shell Injection"](http://s1gnalcha0s.github.io/node/2015/01/31/SSJS-webshell-injection.html)
* __Miscellaneous__
    - [UTF-9 RFC](https://www.ietf.org/rfc/rfc4042.txt)
    - [Dumping WDigest Creds with Meterpreter Mimikatz/Kiwi in Windows 8.1](https://www.trustedsec.com/april-2015/dumping-wdigest-creds-with-meterpreter-mimikatzkiwi-in-windows-8-1/)
    ...
    - [`capturer` module in Python](https://capturer.readthedocs.org/en/latest/#getting-started)
